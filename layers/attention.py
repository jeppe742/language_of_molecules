...
class MultiHeadAttention(Module):
    def __init__(self, in_features, hidden_dim=None, out_features=None, num_heads=1, dropout=0.2, edge_encoding=EDGE_ENCODING_TYPE.RELATIVE_POSITION):
    ...
    def forward(self, key, value, query, mask, adj=None, edges_embedding=None):
        ...
        if self.edge_encoding == EDGE_ENCODING_TYPE.GRAPH or self.edge_encoding==EDGE_ENCODING_TYPE.GRAPH_RELATIVE:
            ...
            attention.masked_fill_((adj == 0).to(torch.bool), -float('inf'))
            adj = adj.squeeze(1)
...
class TransformerLayer(Module):
    def __init__(self, in_features, hidden_dim, num_heads=1, dropout=0.2, edge_encoding=EDGE_ENCODING_TYPE.RELATIVE_POSITION):
        super().__init__()
...
class GraphAttentionLayer(Module):
    def __init__(self, in_features, hidden_dim=None, out_features=None, num_heads=1, edge_encoding=EDGE_ENCODING_TYPE.RELATIVE_POSITION):
